...
I'm deeply interested in how complex systems work: financial systems, geopolitical structures, incentive mechanisms, and how trust can fail at scale. Hundreds of hours of research into systemic risk, monetary policy, and how large systems behave under stress. That mindset is at the core of effective AI governance, because AI doesn't fail in isolation. It fails within the systems organizations have already built.

## The Military Background

Before AI governance, I spent 21 years in the Canadian Armed Forces. Started as an avionics technician on CF-188 Hornets, moved into electronic warfare, then shifted to quality management as an AF9000+ Lead Auditor conducting formal audits of aircraft maintenance operations. I finished as a Warrant Officer running a 10-person instruction cell at CFLRS in Saint-Jean-sur-Richelieu.

The connection is direct. Systematic auditing, risk assessment, process improvement, team leadership: the same skills organizations need to get AI adoption right. The context changed; the discipline didn't.

## Bilingual Advantage

Fully bilingual French-English, based in Saguenay, QC. This matters because Quebec's regulatory environment (Loi 25, provincial AI policy) requires someone who operates natively in both languages. Most AI governance professionals in Canada work in English only. I work in both, which means I can serve Quebec organizations in their language while keeping them aligned with federal and international standards.

## Credentials

**Current:**
- AF9000+ Lead Quality Auditor (Canadian Armed Forces)
- ILP Leadership Program (Royal Military College Saint-Jean)
- AI Ethics (University of Helsinki, completing 2026)
